...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 1
    actual = count_positive_sines([10, 11, 12, 13])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 56
    actual = sum_first_n([22, 12, 15, 7, 9, 12], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 6
    actual = sum_first_n([1, 2, 3, 4, 5, 6,], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
